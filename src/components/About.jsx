                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                    ...
                    <div className="w-full lg:w-[45%]">
                        ...
                        >
                            ...
                            {/* Years badge — visible on md+ */}
                            <div className="absolute -bottom-16 -right-6 md:-bottom-20 md:-right-10 bg-navy p-6 md:p-10 rounded-2xl shadow-xl hidden md:block">
                                <span className="text-4xl md:text-5xl font-bold text-periwinkle block">15+</span>
                                <span className="text-white text-xs md:text-sm font-semibold uppercase tracking-widest">Years of Excellence</span>
                            </div>
                        </motion.div>
                    </div>

                    {/* Text side */}
                    <div className="w-full lg:w-[55%] mt-6 md:mt-16 lg:mt-0">
                        <motion.div
                        ...
                        >
                            ...
                            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-navy mb-5 md:mb-6 leading-tight">
                                Building Kerala's Future Infrastructure
                            </h3>
                            <p className="text-slate-600 text-base sm:text-lg mb-6 md:mb-8 leading-relaxed">
                            ...
                            <p className="text-slate-600 text-base sm:text-lg mb-8 md:mb-10 leading-relaxed">
                            ...
                            <div className="grid grid-cols-2 gap-5 md:gap-8 mb-8 md:mb-10">
                                <div>
                                    <h4 className="font-bold text-navy text-lg md:text-xl mb-2">Modern Facility</h4>
                                    <p className="text-slate-500 text-sm">State-of-the-art fabrication unit in the heart of Kerala.</p>
                                </div>
                                <div>
                                    <h4 className="font-bold text-navy text-lg md:text-xl mb-2">Expert Team</h4>
